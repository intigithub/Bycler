...
UI.registerHelper('getFullCountryCity', function () {
    var fullCountryCity = "";
    return fullCountryCity;
});
UI.registerHelper('getName', function () {
...
print_country = function (country_id) {
...
print_state = function (state_id, state_index) {
